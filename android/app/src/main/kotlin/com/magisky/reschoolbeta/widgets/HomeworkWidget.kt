...
class HomeworkWidget : AppWidgetProvider() {
    ...
    companion object {
        fun updateWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.homework_widget)

            val intent = Intent(context, WidgetListService::class.java)
            intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId)
            intent.putExtra("widget_type", "homework")
            ...
            val jsonData = prefs.getString("widget_homework_data", null)
