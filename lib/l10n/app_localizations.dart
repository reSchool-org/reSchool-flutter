...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ru': {
      ...
      'unofficialAppDisclaimer': 'reSchool - неофициальный клиент eSchool Center, не связанный с его разработчиками. Используя приложение, вы принимаете все связанные риски.',
    ...
    'en': {
      ...
      'unofficialAppDisclaimer': 'reSchool is an unofficial eSchool Center client and is not affiliated with its developers. By using the app, you accept all associated risks.',
