...
class HomeWidgetPlugin :
  ...
  /** если имя провайдера не задано или класс не найден, завершаем result с ошибкой и возвращаем null */
  ...
  companion object {
    ...
    /** ключи расписания HomeWidgetScheduler хранятся в том же файле настроек */
