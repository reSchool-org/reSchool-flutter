# список моделей телефонов, которыми прикидываемся
DEVICES = [
    ...
    # складные Samsung Galaxy Fold и Flip
    ...
    # защищённые Samsung Galaxy XCover
