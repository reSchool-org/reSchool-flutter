...
/// данные домашнего задания для виджета
class WidgetHomeworkData {
  final List<WidgetHomeworkItem> items;
  final String lastUpdated;

  WidgetHomeworkData({required this.items, required this.lastUpdated});
...
/// ключи хранения данных виджетов
...
/// типы виджетов
enum WidgetType { schedule, homework, grades }
...
class WidgetConfig {
  ...
  factory WidgetConfig.fromJson(Map<String, dynamic> json) {
    return WidgetConfig(
      ...
      homeworkItemsCount: ((json['homeworkItemsCount'] as num?)?.toInt() ?? 5)
          .clamp(1, 20),
      gradesSubjectsCount: ((json['gradesSubjectsCount'] as num?)?.toInt() ?? 6)
          .clamp(1, 15),
  ...
  WidgetConfig copyWith({
    ...
    return WidgetConfig(
      ...
      showTeacherInSchedule:
          showTeacherInSchedule ?? this.showTeacherInSchedule,
      showDeadlineInHomework:
          showDeadlineInHomework ?? this.showDeadlineInHomework,
    );
  }
}
