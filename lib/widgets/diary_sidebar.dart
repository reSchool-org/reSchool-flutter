...
/// боковая панель дневника для десктопа: мини календарь и дни недели
class DiarySidebar extends StatelessWidget {
  ...
  Widget _buildMiniCalendar(BuildContext context, ColorScheme colorScheme) {
    ...
    // неделя у нас начинается с понедельника
    int startWeekday = firstOfMonth.weekday - 1; // 0 это понедельник
