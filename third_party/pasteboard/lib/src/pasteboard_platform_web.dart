...
/// приём взят из https://github.com/zenorocha/clipboard.js/blob/master/src/common/create-fake-element.js
HTMLTextAreaElement _createCopyFakeElement(String value) {
  ...
  final fakeElement = HTMLTextAreaElement()
    // так ios не увеличивает страницу при фокусе
    ..style.fontSize = '12pt'
    ..style.border = '0'
    ..style.padding = '0'
...
bool _copyCommand() {
  try {
    ...
    // ошибка очистки не должна мешать копированию
    return false;
  }
}
