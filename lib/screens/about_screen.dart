  ...
  Future<void> _changeDevice() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Устройство: $_deviceModel', style: appFont(context)),
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: BoxConstraints(
              maxWidth: isDesktop(context) ? 600.0 : double.infinity,
            ),
      ...
      child: Column(
        children: [
          ...
          _LinkRow(
            ...
            title: 'kmi-paste',
            subtitle: 'Плагин Obsidian для экспорта',
            colorScheme: colorScheme,
            onTap: () => _launchUrl('https://github.com/magiskyp/kmi-paste'),
          ),
          Divider(
            height: 1,
            color: colorScheme.outline.withValues(alpha: 0.1),
  ...
  Future<void> _launchUrl(String url) async {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:  Text('Не удалось открыть ссылку', style: appFont(context)),
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12),
            ),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              _IconBox(icon: icon, colorScheme: colorScheme),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
